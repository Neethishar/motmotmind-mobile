...
class DrinkWaterCongratulationsPage extends StatefulWidget {
...
class _DrinkWaterCongratulationsPageState
  ...
  Future<void> _loadProgress() async {
    ...
    setState(() {
      completedDays = prefs.getInt('drinkWaterCompletedDays') ?? 1;
    });
  }
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Image.asset('assets/drink.png', height: 60, width: 60),
                  const SizedBox(height: 20),
                  Text(
                    "Drink Water Day $completedDays Complete",
                  ...
                  const Text(
                    "“Awesome! You stayed hydrated today.”",
